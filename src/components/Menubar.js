...
import { postCreation } from "./redux-components/PostSlice";
//import { postsCreation } from "./redux-components/PostSlice";
export default function Menubar() {
    ...
    const postHandler = (e) => {
        // e.preventDefault();
        dispatch(postCreation({ author, images, caption,likesCount }));
    ...
    return (
        <Grid style={{ position: "sticky", top: 0 }}>
            ...
            <List>
                ...
                <ListItem style={{ marginTop: "150px", height: "50px" }} disablePadding>
                    <ListItemButton>
                        <ListItemIcon>
